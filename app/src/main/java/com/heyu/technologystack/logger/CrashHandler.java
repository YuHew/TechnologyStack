...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private static final String LOG_PATH = Environment.getDataDirectory() +"/heyu/crash/";
	...
	private void dumpExceptionToSDCard(Throwable ex) throws IOException {
        ...
        try {
            ...
            //Commander.saveExceptionLog(ex.getMessage()+"-time-"+time);

            StringWriter sw = new StringWriter();
            PrintWriter pwStr = new PrintWriter(sw);
            ex.printStackTrace(pwStr);
    ...
    private void dumpPhoneInfo(StringBuffer stringBuffer) throws NameNotFoundException {
        //应用的版本名称和版本号
        PackageManager pm = mContext.getPackageManager();
        PackageInfo pi = pm.getPackageInfo(mContext.getPackageName(), PackageManager.GET_ACTIVITIES);
